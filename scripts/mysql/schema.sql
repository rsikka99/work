...
-- -----------------------------------------------------
-- Table `toner_vendor_ranking_sets`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `toner_vendor_ranking_sets` (
    `id` INT NOT NULL AUTO_INCREMENT,
    PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `assessment_settings` (
    ...
    `customerMonochromeRankSetId` INT(11)  NULL DEFAULT NULL,
    `customerColorRankSetId`      INT(11)  NULL DEFAULT NULL,
    `dealerMonochromeRankSetId`   INT(11)  NULL DEFAULT NULL,
    `dealerColorRankSetId`        INT(11)  NULL DEFAULT NULL,
    ...
    PRIMARY KEY (`id`),
    INDEX `assessment_settings_ibfk_1_idx` (`customerMonochromeRankSetId` ASC),
    INDEX `assessment_settings_ibfk_2_idx` (`customerColorRankSetId` ASC),
    INDEX `assessment_settings_ibfk_3_idx` (`dealerMonochromeRankSetId` ASC),
    INDEX `assessment_settings_ibfk_4_idx` (`dealerColorRankSetId` ASC),
    CONSTRAINT `assessment_settings_ibfk_1`
    FOREIGN KEY (`customerMonochromeRankSetId`)
    REFERENCES `toner_vendor_ranking_sets` (`id`)
        ON DELETE RESTRICT
        ON UPDATE RESTRICT,
    CONSTRAINT `assessment_settings_ibfk_2`
    FOREIGN KEY (`customerColorRankSetId`)
    REFERENCES `toner_vendor_ranking_sets` (`id`)
        ON DELETE RESTRICT
        ON UPDATE RESTRICT,
    CONSTRAINT `assessment_settings_ibfk_3`
    FOREIGN KEY (`dealerMonochromeRankSetId`)
    REFERENCES `toner_vendor_ranking_sets` (`id`)
        ON DELETE NO ACTION
        ON UPDATE NO ACTION,
    CONSTRAINT `assessment_settings_ibfk_4`
    FOREIGN KEY (`dealerColorRankSetId`)
    REFERENCES `toner_vendor_ranking_sets` (`id`)
        ON DELETE NO ACTION
        ON UPDATE NO ACTION)
    AUTO_INCREMENT = 2;
...
CREATE TABLE IF NOT EXISTS `hardware_optimization_settings` (
    ...
    `dealerMonochromeRankSetId`      INT(11) NULL,
    `dealerColorRankSetId`           INT(11) NULL,
    `replacementMonochromeRankSetId` INT(11) NULL,
    `replacementColorRankSetId`      INT(11) NULL,
    PRIMARY KEY (`id`),
    INDEX `hardware_optimization_settings_ibkf1_idx` (`dealerMonochromeRankSetId` ASC),
    INDEX `hardware_optimization_settings_ibkf2_idx` (`dealerColorRankSetId` ASC),
    INDEX `hardware_optimization_settings_ibkf3_idx` (`replacementMonochromeRankSetId` ASC),
    INDEX `hardware_optimization_settings_ibkf3_idx1` (`replacementColorRankSetId` ASC),
    CONSTRAINT `hardware_optimization_settings_ibkf1`
    FOREIGN KEY (`dealerMonochromeRankSetId`)
    REFERENCES `toner_vendor_ranking_sets` (`id`)
        ON DELETE NO ACTION
        ON UPDATE NO ACTION,
    CONSTRAINT `hardware_optimization_settings_ibkf2`
    FOREIGN KEY (`dealerColorRankSetId`)
    REFERENCES `toner_vendor_ranking_sets` (`id`)
        ON DELETE NO ACTION
        ON UPDATE NO ACTION,
    CONSTRAINT `hardware_optimization_settings_ibkf3`
    FOREIGN KEY (`replacementMonochromeRankSetId`)
    REFERENCES `toner_vendor_ranking_sets` (`id`)
        ON DELETE NO ACTION
        ON UPDATE NO ACTION,
    CONSTRAINT `hardware_optimization_settings_ibkf3`
    FOREIGN KEY (`replacementColorRankSetId`)
    REFERENCES `toner_vendor_ranking_sets` (`id`)
        ON DELETE NO ACTION
        ON UPDATE NO ACTION);
...
-- -----------------------------------------------------
-- Table `toner_vendor_manufacturers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `toner_vendor_manufacturers` (
    `manufacturerId` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `toner_vendor_rankings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `toner_vendor_rankings` (
