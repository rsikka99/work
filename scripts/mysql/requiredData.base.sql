...
INSERT INTO `dealers` (`id`, `dealerName`, `userLicenses`, `quoteSettingId`, `reportSettingId`, `dateCreated`)
    VALUES (1, 'Root Company', 1000, 1, 1, '2013-03-12'),
           (2, 'Tangent MTW', 1000, 1, 1, '2013-03-12');
