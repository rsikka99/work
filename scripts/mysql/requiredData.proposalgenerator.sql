...
INSERT INTO `hardware_optimization_settings` (`id`, `costThreshold`,`adminCostPerPage`, `laborCostPerPage`, `partsCostPerPage`, `customerPricingConfigId`, `dealerMargin`, `dealerPricingConfigId`, `targetColorCostPerPage`, `targetMonochromeCostPerPage`, `replacementPricingConfigId`) VALUES
(1, 25.50, 0.0006, 0.002, 0.0015, 3, 20, 3, 0.10, 0.02, 3);
