...
CREATE  TABLE IF NOT EXISTS `proposalgenerator_master_devices` (
  ...
  `device_price` DOUBLE NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `proposalgenerator_unknown_device_instances` (
  ...
  `black_toner_price` DOUBLE NULL DEFAULT NULL ,
  `black_toner_yield` INT(11) NULL DEFAULT NULL ,
  `cyan_toner_SKU` VARCHAR(255) NULL DEFAULT NULL ,
  `cyan_toner_price` DOUBLE NULL DEFAULT NULL ,
  `cyan_toner_yield` INT(11) NULL DEFAULT NULL ,
  `magenta_toner_SKU` VARCHAR(255) NULL DEFAULT NULL ,
  `magenta_toner_price` DOUBLE NULL DEFAULT NULL ,
  `magenta_toner_yield` INT(11) NULL DEFAULT NULL ,
  `yellow_toner_SKU` VARCHAR(255) NULL DEFAULT NULL ,
  `yellow_toner_price` DOUBLE NULL DEFAULT NULL ,
  `yellow_toner_yield` INT(11) NULL DEFAULT NULL ,
  `3color_toner_SKU` VARCHAR(255) NULL DEFAULT NULL ,
  `3color_toner_price` DOUBLE NULL DEFAULT NULL ,
  `3color_toner_yield` INT(11) NULL DEFAULT NULL ,
  `4color_toner_SKU` VARCHAR(255) NULL DEFAULT NULL ,
  `4color_toner_price` DOUBLE NULL DEFAULT NULL ,
  `4color_toner_yield` INT(11) NULL DEFAULT NULL ,
  `black_comp_SKU` VARCHAR(255) NULL DEFAULT NULL ,
  `black_comp_price` DOUBLE NULL DEFAULT NULL ,
  `black_comp_yield` INT(11) NULL DEFAULT NULL ,
  `cyan_comp_SKU` VARCHAR(255) NULL DEFAULT NULL ,
  `cyan_comp_price` DOUBLE NULL DEFAULT NULL ,
  `cyan_comp_yield` INT(11) NULL DEFAULT NULL ,
  `magenta_comp_SKU` VARCHAR(255) NULL DEFAULT NULL ,
  `magenta_comp_price` DOUBLE NULL DEFAULT NULL ,
  `magenta_comp_yield` INT(11) NULL DEFAULT NULL ,
  `yellow_comp_SKU` VARCHAR(255) NULL DEFAULT NULL ,
  `yellow_comp_price` DOUBLE NULL DEFAULT NULL ,
  `yellow_comp_yield` INT(11) NULL DEFAULT NULL ,
  `3color_comp_SKU` VARCHAR(255) NULL DEFAULT NULL ,
  `3color_comp_price` DOUBLE NULL DEFAULT NULL ,
  `3color_comp_yield` INT(11) NULL DEFAULT NULL ,
  `4color_comp_SKU` VARCHAR(255) NULL DEFAULT NULL ,
  `4color_comp_price` DOUBLE NULL DEFAULT NULL ,
  `4color_comp_yield` INT(11) NULL DEFAULT NULL ,
