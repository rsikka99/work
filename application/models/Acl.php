...
class Application_Model_Acl extends Zend_Acl
{
    ...
    protected function _setupResources ()
    {
        ...
        $this->addResource(self::RESOURCE_PROPOSALGEN_REPORT_OLDDEVICELIST_WILDCARD);
...
//        $this->allow(self::ROLE_PROPOSAL_USER, self::RESOURCE_PROPOSALGEN_ADMIN_FILTERLISTITEMS, self::PRIVILEGE_VIEW);
        ...
        $this->allow(self::ROLE_PROPOSAL_USER, self::RESOURCE_PROPOSALGEN_REPORT_OLDDEVICELIST_WILDCARD, self::PRIVILEGE_VIEW);
