 ...
 */
class Application_Model_Mapper_Dealer_Feature extends My_Model_Mapper_Abstract
{
    /*
     * Column Definitions
     */
     ...
     *
     */
    protected $_defaultDbTable = 'Application_Model_DbTable_Dealer_Feature';

    /**
     * Gets an instance of the mapper
     *
     * @return Application_Model_Mapper_Dealer_Feature
     */
    ...
    /**
     * Saves an instance of Application_Model_Dealer_Feature to the database.
     * If the id is null then it will insert a new row
     *
     * @param $object Application_Model_Dealer_Feature
    ...
    /**
     * Saves (updates) an instance of Application_Model_Dealer_Feature to the database.
     *
     * @param $object     Application_Model_Dealer_Feature
     ...
     *
     * @param $object mixed
     *                This can either be an instance of Application_Model_Dealer_Feature or the
    ...
    {
        if ($object instanceof Application_Model_Dealer_Feature)
        {
            $whereClause = array(
     ...
     *
     * @return Application_Model_Dealer_Feature
     */
    public function find ($id)
    {
        // Get the item from the cache and return it if we find it.
        $result = $this->getItemFromCache($id);
        if ($result instanceof Application_Model_Dealer_Feature)
        {
            return $result;
        }
        ...
        $row    = $result->current();
        $object = new Application_Model_Dealer_Feature($row->toArray());
    ...
    /**
     * @param Application_Model_Dealer_Feature $object
     *
     * @return int
     */
