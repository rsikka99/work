...
class Quotegen_Model_Mapper_LeasingSchemaTerm extends My_Model_Mapper_Abstract
{
     ...
     *
     * @param $leasingSchema Quotegen_Model_LeasingSchemaTerm
     *            The object to insert
     * @return mixed The primary key of the new row
     */
    public function insert ($data)
    {
        if ($data instanceof Quotegen_Model_LeasingSchemaTerm)
        {
            $data = $data->toArray();
        }
     ...
     *
     * @param $client Quotegen_Model_LeasingSchemaTerm
    ...
    public function find ($id)
    {
        ...
        $row = $result->current();
        return new Quotegen_Model_LeasingSchemaTerm($row->toArray());
    }
    ...
    public function fetchAll ($where = null, $order = null, $count = 25, $offset = null)
    {
        ...
        {
            $entries [] = new Quotegen_Model_LeasingSchemaTerm($row->toArray());
        }
        return $entries;
    }
