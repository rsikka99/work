...
/**
 * Class Healthcheck_Model_Mapper_Healthcheck_Setting
 */
class Healthcheck_Model_Mapper_Healthcheck_Setting extends My_Model_Mapper_Abstract
{
    /*
     ...
     *
     */
    protected $_defaultDbTable = 'Healthcheck_Model_DbTable_Healthcheck_Setting';

    /**
     * Gets an instance of the mapper
     *
     * @return Healthcheck_Model_Mapper_Healthcheck_Setting
     */
    ...
    /**
     * Saves an instance of Healthcheck_Model_Healthcheck_Setting to the database.
     * If the id is null then it will insert a new row
     *
     * @param $object Healthcheck_Model_Healthcheck_Setting
    ...
    /**
     * Saves (updates) an instance of Healthcheck_Model_Healthcheck_Setting to the database.
     *
     * @param $object     Healthcheck_Model_Healthcheck_Setting
     ...
     *
     * @param $object mixed
     *                This can either be an instance of Healthcheck_Model_Healthcheck_Setting or the
    ...
    {
        if ($object instanceof Healthcheck_Model_Healthcheck_Setting)
        {
            $whereClause = array(
    ...
    public function find ($id)
    {
        ...
        if ($result instanceof Healthcheck_Model_Healthcheck_Setting)
        {
            return $result;
        }
        ...
        $row    = $result->current();
        $object = new Healthcheck_Model_Healthcheck_Setting($row->toArray());
    ...
    /**
     * @param Healthcheck_Model_Healthcheck_Setting $object
     *
     * @return int
     */
     ...
     *            The user's id
     *
     * @return Healthcheck_Model_Healthcheck_Setting Returns false if it could not find one.
     */
