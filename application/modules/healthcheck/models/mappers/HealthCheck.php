 ...
 */
class Healthcheck_Model_Mapper_Healthcheck extends My_Model_Mapper_Abstract
{
    /*
     ...
     *
     */
    protected $_defaultDbTable = 'Healthcheck_Model_DbTable_Healthcheck';

    /**
     * Gets an instance of the mapper
     *
     * @return Healthcheck_Model_Mapper_Healthcheck
     */
     ...
     *
     * @param $object Healthcheck_Model_Healthcheck
    ...
    /**
     * Saves (updates) an instance of Healthcheck_Model_Healthcheck to the database.
     *
     * @param $object     Healthcheck_Model_Healthcheck
     ...
     *
     * @param $object mixed
     *                This can either be an instance of Healthcheck_Model_Healthcheck or the
    ...
    {
        if ($object instanceof Healthcheck_Model_Healthcheck)
        {
            $whereClause = array(
    ...
    public function find ($id)
    {
        ...
        if ($result instanceof Healthcheck_Model_Healthcheck)
        {
            return $result;
        }
        ...
        $row    = $result->current();
        $object = new Healthcheck_Model_Healthcheck($row->toArray());
    ...
    /**
     * @param Healthcheck_Model_Healthcheck $object
     *
     * @return int
     */
    ...
    public function findRmsUploadRowByHardwareOptimizationId($healthcheckId)
    {
        ...
        if ($healthcheck instanceof Healthcheck_Model_Healthcheck)
        {
