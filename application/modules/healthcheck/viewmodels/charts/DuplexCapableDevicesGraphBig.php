...
{
    $colorPercentage = round((($this->getDevices()->duplexCapableDeviceInstances->getCount() / $this->getDevices()->allIncludedDeviceInstances->getCount()) * 100), 2);
}
...
$myPicture->drawText(130, 20, "Duplex-capable Printing Devices", ["FontSize" => 9, "R" => 0, "G" => 0, "B" => 0, "Align" => TEXT_ALIGN_BOTTOMMIDDLE]);
