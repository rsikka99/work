...
use MPSToolbox\Entities\ExtServiceEntity;
use Tangent\Controller\Action;

/**
 * Class Api_ServicesController
 *
 * This controller handles everything to do with creating/updating Services
 */
class Api_ServicesController extends Action implements \Tangent\Grid\DataAdapter\DataAdapterInterface
{
    ...
    public function init()
    {
        ...
        $this->qb = ExtServiceEntity::getRepository()
    ...
    public function indexAction ()
    {
        ...
        if ($hardwareId !== false)
        {
            $this->sendJson(ExtServiceEntity::find($hardwareId)->toArray());
            return;
        }
