...
use MPSToolbox\Entities\ExtPeripheralEntity;
use Tangent\Controller\Action;

/**
 * Class Api_PeripheralsController
 *
 * This controller handles everything to do with creating/updating Peripherals
 */
class Api_PeripheralsController extends Action implements \Tangent\Grid\DataAdapter\DataAdapterInterface
{
    ...
    public function init()
    {
        ...
        $this->qb = ExtPeripheralEntity::getRepository()
    ...
    public function indexAction ()
    {
        ...
        if ($hardwareId !== false)
        {
            $this->sendJson(ExtPeripheralEntity::find($hardwareId)->toArray());
            return;
        }
