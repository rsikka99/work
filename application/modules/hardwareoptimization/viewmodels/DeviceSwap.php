<?php
class Hardwareoptimization_ViewModel_DeviceSwap
{
    /**
     * @var array
     */
    ...
    public function getCostPerPageSetting ()
    {
        if (!isset($this->_costPerPageSetting))
        {
            ...
            $this->_costPerPageSetting->pricingConfiguration = Proposalgen_Model_Mapper_PricingConfig::getInstance()->find(Proposalgen_Model_PricingConfig::OEM);
        }
    ...
    public function getReplacementDevices ()
    {
        ...
        {
            $this->_replacementDevices = Hardwareoptimization_Model_Mapper_Device_Swap::getInstance()->fetchAll();
        }
