...
class Proposalgen_Form_Survey extends Zend_Form
{
    ...
    public function addSubmitButton (Zend_Form_SubForm $subForm)
    {
        ...
        $subForm->addElement('RawText', 'sumitBtns-start', array ( 'value' => '<div id="submitBtns">' ));
        ...
        $savebtn->setDecorators(array (
            'ViewHelper', 
            'Errors', 
            array ( array ( 'div' => 'HtmlTag' ), array ( 'tag' => 'div', 'class' => 'savebtn' ) ) 
        ));
        ...
        $backbtn->setLabel('Back')->setDecorators(array (
            'ViewHelper', 
            'Errors', 
            array ( array ( 'div' => 'HtmlTag' ), array ( 'tag' => 'div', 'class' => 'backbtn' ) ) 
        ));
        ...
        $subForm->addElement('RawText', 'sumitBtns-end', array ( 'value' => '</div>' ));
