 ...
 * The main survey form will contain a collection of subforms.
 * This allows
...
class Proposalgen_Form_Survey extends Zend_Form
{
    ...
    public function init ()
    {
        ...
        $companyInfo->addElement('RawText', 'OpenDiv', array (
                'value' => '<div id="elements_container">' 
        ));
        ...
        $companyInfo->addElement('RawText', 'CloseDiv', array (
                'value' => '</div>' 
        ));
        ...
        $general->addElement('RawText', 'OpenDiv', array (
                'value' => '<div id="elements_container">' 
        ));
        ...
        $general->addElement('RawText', 'CloseDiv', array (
                'value' => '</div>' 
        ));
        ...
        $finance->addElement('RawText', 'OpenDiv', array (
                'value' => '<div id="elements_container">' 
        ));
        
        $toner_cost_radio = new Zend_Form_Element_Radio('toner_cost_radio');
        $toner_cost_radio->addMultiOption("guess", "I don't know")
        ...
        $toner_cost->setAttrib('style', 'width: 55px;')
        ...
        $labor_cost_radio->addMultiOption("guess", "I don't know")
            ->addMultiOption('I know the exact amount', 'I know the exact amount')
            ->setAttrib('tmtw', 'textual')
            ->setAttrib('id', '12a')
            ->setValue('I know the exact amount');
        ...
        $labor_cost->setAttrib('style', 'width: 55px;')
            ->setAttrib('maxlength', 7)
            ->setAttrib('tmtw', 'numeric')
            ->setAttrib('id', '12')
            ->setDescription('$')
        ...
        /*
         * REMOVING QUESTION $hardware_costs = new Zend_Form_Element_Text('hardware_costs');
         * $hardware_costs->setRequired(true) ->setAttrib('style', 'width: 55px;') ->setRequired(true)
         * ->setAttrib('maxlength', 7) ->addValidator('regex', false, array ( 'pattern' => $currencyRegex, 'messages' =>
         * array ( 'regexNotMatch' => "Please enter a valid dollar amount." ) )) ->setAttrib('tmtw', 'numeric')
         * ->setAttrib('id', '13') ->setValue(money_format('%i', 1000)) ->setDescription('$')
         * ->addValidator('greaterThan', true, array ( 'min' => 0 )) ->setDecorators(array ( array ( 'Description',
         * array ( 'escape' => false, 'tag' => false ) ), 'ViewHelper', 'Errors', array ( 'HtmlTag', array ( 'id' =>
         * 'hardware_costs-element' ) ), array ( 'Label' ) )); $hardwareQst = "How much in total did you spend last year
         * on printer hardware purchases? The average purchase price is $1,000 per device.";
         * $hardware_costs->setLabel($hardwareQst); $finance->addElement($hardware_costs);
         */
        ...
        $avg_purchase->setRequired(true)
            ...
            ->addValidator('regex', false, array (
                ...
                'messages' => array (
                        'regexNotMatch' => "Please enter a valid dollar amount." 
                ) 
        ))
            ->setAttrib('tmtw', 'numeric')
            ->setAttrib('id', '14')
        ...
        $finance->addElement('RawText', 'CloseDiv', array (
                'value' => '</div>' 
        ));
        ...
        $purchasing->addElement('RawText', 'OpenDiv', array (
                'value' => '<div id="elements_container">' 
        ));
        ...
        $ink_toner_order->setAttrib('style', 'width: 30px;')
            ->setAttrib('maxlength', 7)
            ->setAttrib('tmtw', 'numeric')
            ->setAttrib('id', '17')
            ->setAllowEmpty(false)
        ...
        $purchasing->addElement('RawText', 'CloseDiv', array (
                'value' => '</div>' 
        ));
        ...
        $it->addElement('RawText', 'OpenDiv', array (
                'value' => '<div id="elements_container">' 
        ));
        
        $itHoursRadio = new Zend_Form_Element_Radio('itHoursRadio');
        $itHoursRadio->addMultiOption('guess', 'I don\'t know')->addMultiOption('I know the exact amount', 'I know the exact amount');
        ...
        $itHours->setAttrib('style', 'width: 30px;')
            ->setAttrib('maxlength', 3)
            ->setAttrib('tmtw', 'numeric')
            ->setAttrib('id', '18')
            ->setAllowEmpty(false)
        ...
        $monthlyBreakdown->setAttrib('style', 'width: 55px;')
            ->setAttrib('maxlength', 7)
            ->setAttrib('tmtw', 'numeric')
            ->setAttrib('id', '24')
            ->setDescription('$')
        ...
        $monthlyBreakdownRadio->addMultiOption('guess', 'I don\'t know')->addMultiOption('I know the exact amount', 'I know the exact amount');
        ...
        $it->getElement('monthlyBreakdownRadio')
            ...
            ->setDecorators(array (
                ...
                array (
                        'HtmlTag', 
                        array (
                                'id' => 'monthlyBreakdownRadio-element' 
                        ) 
                ), 
                array (
                        'Label' 
        ...
        $it->addElement('RawText', 'CloseDiv', array (
                'value' => '</div>' 
        ));
        ...
        $users->addElement('RawText', 'OpenDiv', array (
                'value' => '<div id="elements_container">' 
        ));
        
        $users->setDecorators(array (
                'FormElements', 
                array (
                        'HtmlTag', 
                        array (
        ...
        /*
         * $users->addPrefixPath('Tangent_Form_Element', 'Tangent/Form/Element/', 'element'); $users->addElement(
         * 'Note', 'myElementId', array( 'value'=>'<p>'.$pageCoverageQst.'</p>', 'disableLoadDefaultDecorators' => true,
        ...
        $users->addElement('RawText', 'CloseDiv', array (
                'value' => '</div>' 
        ));
    ...
    public function addSubmitButton (Zend_Form_SubForm $subForm)
    {
        ...
        $subForm->addElement('RawText', 'DivStart', array (
                'value' => '<div class="submitBar">' 
        ));
        
        $subForm->addElement('RawText', 'sumitBtns-start', array (
                'value' => '<div id="submitBtns">' 
        ));
        ...
        $backbtn = new Zend_Form_Element_Button('back_button', array (
                'disableLoadDefaultDecorators' => true 
        ));
        ...
        $subForm->addPrefixPath('Tangent_Form_Element', 'Tangent/Form/Element/', 'element');
        $subForm->addElement('RawText', 'DivEnd', array (
                'value' => '</div>' 
        ));
        $subForm->addElement('RawText', 'sumitBtns-end', array (
                'value' => '</div>' 
        ));
