...
class Proposalgen_Form_Survey extends Zend_Form
{
    ...
    public function init ()
    {
        ...
        $currencyValidator = new Zend_Validate_Regex($this->currencyRegex);
         ...
         * ->setAttrib('id', '13') ->setValue($currency->toCurrency(1000)) ->setDescription('$')
