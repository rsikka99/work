                    ...
                    try
                    {
                        ...
                        if ($toners_valid == true)
                        {
                            ...
                            $master_deviceData = array (
                                    'launch_date' => $launch_date->toString('yyyy-MM-dd HH:ii:ss'), 
                            ...
                            else
                            {
                                ...
                                if ($manufacturer_id > 0)
                                {
                                    ...
                                    // check for master device flagged as
                                    // deleted
    ...
    public function manageticketdevicesAction ()
    {
        ...
        if ($this->_request->isPost())
        {
            ...
            if ($formData ['form_mode'] == "ticket")
            {
                ...
                $this->view->done_action = "javascript: document.location.href='" . $this->view->baseUrl() . "/ticket/ticketdetails?id=" . $ticket_id . "'";
            }
        ...
        if ($this->_request->isPost())
        {
            ...
            if ($formData ['form_mode'] == 'mapping')
            {
                ...
                else
                {
                    ...
                    // get device info
                    $upload_data_collectorMapper = Proposalgen_Model_Mapper_UploadDataCollector::getInstance();
