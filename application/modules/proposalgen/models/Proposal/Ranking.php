...
class Proposalgen_Model_Proposal_Ranking extends Tangent_Model_Abstract
{
    ...
    public function getExpense ()
    {
        if (! isset($this->Expense))
        {
            ...
            $rankingText .= " Under the PrintIQ� program, we estimate that we can save " . $this->proposal->getReport()->customerCompanyName . " up to $" . number_format($this->proposal->getPrintIQSavings()) . " annually.";
