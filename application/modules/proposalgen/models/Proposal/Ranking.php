...
class Proposalgen_Model_Proposal_Ranking extends Tangent_Model_Abstract
{
    ...
    public function getSuppliesAndServiceLogistics ()
    {
        if (!isset($this->SuppliesAndServiceLogistics))
        {
            ...
            {
                $rankingText .= " To improve your score in this area, " . $this->proposal->report->customerCompanyName . " could ";
    ...
    public function getExpense ()
    {
        if (!isset($this->Expense))
        {
            ...
            $rankingText .= " Under the PrintIQ� program, we estimate that we can save " . $this->proposal->report->customerCompanyName . " up to $" . number_format($this->proposal->getPrintIQSavings()) . " annually.";
