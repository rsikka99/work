...
class Proposalgen_Model_Mapper_QuestionSetQuestion extends Tangent_Model_Mapper_Abstract
{
    ...
    public function mapRowToObject (Zend_Db_Table_Row $row)
    {
        ...
        try
        {
            ...
            $object->setQuestionId($row->question_id)->setQuestionSetId($row->questionset_id);
        }
        catch ( Exception $e )
        {
            throw new Exception("Failed to map a questionset question row", 0, $e);
        }
        return $object;
    }
    ...
    public function save (Proposalgen_Model_QuestionSet $object)
    {
        ...
        try
        {
            ...
            $data ["questionset_id"] = $object->getQuestionSetName();
