...
class Proposalgen_Model_Mapper_Dealer_Master_Device_Attribute extends My_Model_Mapper_Abstract
{
     ...
     *
     */
    protected $_defaultDbTable = 'Proposalgen_Model_DbTable_Dealer_Master_Device_Attribute';

    /**
     * Gets an instance of the mapper
     *
     * @return Proposalgen_Model_Mapper_Dealer_Master_Device_Attribute
     */
     ...
     *
     * @param $object Proposalgen_Model_Dealer_Master_Device_Attribute
    ...
    /**
     * Saves (updates) an instance of Proposalgen_Model_Dealer_Master_Device_Attribute to the database.
     *
     * @param $object     Proposalgen_Model_Dealer_Master_Device_Attribute
     ...
     *
     * @param $object mixed
     *                This can either be an instance of Proposalgen_Model_Dealer_Master_Device_Attribute or the
    ...
    {
        if ($object instanceof Proposalgen_Model_Dealer_Master_Device_Attribute)
        {
            $whereClause = array(
    ...
    public function find ($id)
    {
        ...
        if ($result instanceof Proposalgen_Model_Dealer_Master_Device_Attribute)
        {
            return $result;
        }
        ...
        $row    = $result->current();
        $object = new Proposalgen_Model_Dealer_Master_Device_Attribute($row->toArray());
    ...
    /**
     * @param Proposalgen_Model_Dealer_Master_Device_Attribute $object
     *
     * @return int
     */
