...
class Proposalgen_Model_Mapper_Rms_Master_Matchup extends My_Model_Mapper_Abstract
{
     ...
     *
     */
    protected $_defaultDbTable = 'Proposalgen_Model_DbTable_Rms_Master_Matchup';

    /**
     * Gets an instance of the mapper
     *
     * @return Proposalgen_Model_Mapper_Rms_Master_Matchup
     */
    ...
    /**
     * Saves an instance of Proposalgen_Model_Rms_Master_Matchup to the database.
    ...
    /**
     * Saves (updates) an instance of Proposalgen_Model_Rms_Master_Matchup to the database.
     *
     * @param $object     Proposalgen_Model_Rms_Master_Matchup
    ...
    {
        if ($object instanceof Proposalgen_Model_Rms_Master_Matchup)
        {
    ...
    public function find ($id)
    {
        ...
        if ($result instanceof Proposalgen_Model_Rms_Master_Matchup)
        {
            return $result;
        }
        ...
        $row    = $result->current();
        $object = new Proposalgen_Model_Rms_Master_Matchup($row->toArray());
