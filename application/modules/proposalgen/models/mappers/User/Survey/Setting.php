...
class Proposalgen_Model_Mapper_User_Survey_Setting extends My_Model_Mapper_Abstract
{
     ...
     */
    public function insert (Proposalgen_Model_User_Survey_Setting &$user_survey_setting)
    {
     ...
     */
    public function save (Proposalgen_Model_User_Survey_Setting $user_survey_setting, $primaryKey = null)
    {
