...
class Proposalgen_Model_Mapper_User_Report_Setting extends My_Model_Mapper_Abstract
{
     ...
     *
     * @param $object Proposalgen_Model_User_Report_Setting
     ...
     *
     * @param $object mixed
     *                This can either be an instance of Proposalgen_Model_User_Report_Setting or the
    ...
    {
        if ($object instanceof Proposalgen_Model_User_Report_Setting)
        {
            $whereClause = array(
     ...
     *
     * @return Proposalgen_Model_User_Report_Setting
     */
    public function find ($id)
    {
        // Get the item from the cache and return it if we find it.
        $result = $this->getItemFromCache($id);
        if ($result instanceof Proposalgen_Model_User_Report_Setting)
        {
            return $result;
        }
        ...
        $row    = $result->current();
        $object = new Proposalgen_Model_User_Report_Setting($row->toArray());
    ...
    /**
     * @param Proposalgen_Model_User_Report_Setting $object
     *
     * @return mixed
     */
