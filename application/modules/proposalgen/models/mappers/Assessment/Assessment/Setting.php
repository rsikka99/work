<?php
class Proposalgen_Model_Mapper_Assessment_Assessment_Setting extends My_Model_Mapper_Abstract
{
    /*
     ...
     *
     */
    protected $_defaultDbTable = 'Proposalgen_Model_DbTable_Assessment_Assessment_Setting';

    /**
     * Gets an instance of the mapper
     *
     * @return Proposalgen_Model_Mapper_Assessment_Assessment_Setting
     */
     ...
     *
     * @param $object Proposalgen_Model_Assessment_Assessment_Setting
    ...
    {
        if ($object instanceof Proposalgen_Model_Assessment_Assessment_Setting)
        {
            $whereClause = array(
     ...
     *
     * @return Proposalgen_Model_Assessment_Assessment_Setting
     */
    public function find ($id)
    {
        // Get the item from the cache and return it if we find it.
        $result = $this->getItemFromCache($id);
        if ($result instanceof Proposalgen_Model_Assessment_Assessment_Setting)
        {
            return $result;
        }
        ...
        $row    = $result->current();
        $object = new Proposalgen_Model_Assessment_Assessment_Setting($row->toArray());
    ...
    /**
     * @param Proposalgen_Model_Assessment_Assessment_Setting $object
     *
     * @return int
     */
