...
/**
 * Class Dealermanagement_Service_Dealer_Branding
 */
class Dealermanagement_Service_Dealer_Branding extends Tangent_Service_Abstract
{
     ...
     * The form
     *
     * @var Dealermanagement_Form_Dealer_Branding
     */
     ...
     * Gets the form
     *
     * @return Dealermanagement_Form_Dealer_Branding
     */
    public function getDealerBrandingForm ()
    {
        if (!isset($this->_dealerBrandingForm))
        {
            $this->_dealerBrandingForm = new Dealermanagement_Form_Dealer_Branding();
        }
    ...
    public function create ($data, $dealerId)
    {
        ...
        if ($filteredData !== false)
        {
            ...
            Application_Model_Mapper_Dealer_Branding::getInstance()->insert($dealerBranding);
        }
    ...
    {
        $success              = false;
        $dealerBrandingMapper = Application_Model_Mapper_Dealer_Branding::getInstance();
    ...
    {
        $success = false;
        if (Application_Model_Mapper_Dealer_Branding::getInstance()->delete($id) > 0)
        {
            $success = true;
        }
        else
