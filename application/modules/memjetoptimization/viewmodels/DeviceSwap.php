...
class Memjetoptimization_ViewModel_DeviceSwap
{
    ...
    /**
     * @var Memjetoptimization_Model_Device_Swap[]
     */
    ...
    /**
     * @return Memjetoptimization_Model_Device_Swap[]
     */
    public function getReplacementDevices ()
    {
        if (!isset($this->_replacementDevices))
        {
            $this->_replacementDevices = Memjetoptimization_Model_Mapper_Device_Swap::getInstance()->fetchAll();
        }
