...
/**
 * Class Memjetoptimization_Form_Memjet_Optimization_Navigation
 */
class Memjetoptimization_Form_Memjet_Optimization_Navigation extends Twitter_Bootstrap_Form
{
    const BUTTONS_ALL       = 1;
