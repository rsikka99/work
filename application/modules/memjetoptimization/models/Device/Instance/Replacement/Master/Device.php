<?php
/**
 * Class Memjetoptimization_Model_Device_Instance_Replacement_Master_Device
 */
class Memjetoptimization_Model_Device_Instance_Replacement_Master_Device extends My_Model_Abstract
{
    /**
     * @var int
     */
