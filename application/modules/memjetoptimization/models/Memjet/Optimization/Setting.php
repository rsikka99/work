 ...
 */
class Memjetoptimization_Model_Memjet_Optimization_Setting extends My_Model_Abstract
{
    /**
     * @var int
     */
    ...
    public function populate ($params)
    {
        ...
        if (isset($params->blackToColorRatio) && !is_null($params->blackToColorRatio))
        {
            $this->blackToColorRatio = $params->blackToColorRatio;
        }
    ...
    public function getReplacementColorRankSet ()
    {
        if (!isset($this->_replacementColorRankSet))
        {
            ...
            else
            {
                ...
                // Update ourselves
                Memjetoptimization_Model_Mapper_Memjet_Optimization_Setting::getInstance()->save($this);
            }
        }
