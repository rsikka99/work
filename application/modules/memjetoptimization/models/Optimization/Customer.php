<?php
/**
 * Class Memjetoptimization_Model_Optimization_Customer
 */
class Memjetoptimization_Model_Optimization_Customer extends Memjetoptimization_Model_Optimization_Abstract
{
    ...
    public function getGraphs ()
    {
        if (!isset($this->_graphs))
        {
            ...
            /**
             * -- Memjet Optimization Device Summary Listing
             */
            ...
            /**
             * -- Memjet Utilization and Capacity Percent version
             */
            ...
            $barGraph->setLegend(array_reverse(Memjetoptimization_Model_Optimization_Abstract::$ageRanks));
