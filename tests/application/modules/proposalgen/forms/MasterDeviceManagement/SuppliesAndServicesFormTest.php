...
class Proposalgen_Form_MasterDeviceManagement_SuppliesAndServicesFormTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Proposalgen_Form_MasterDeviceManagement_SuppliesAndService
     */
    protected $_form;

    public function setUp ()
    {
        $this->_form = new Proposalgen_Form_MasterDeviceManagement_SuppliesAndService();
        parent::setUp();
    }
    ...
    {
        $xml  = simplexml_load_file(__DIR__ . "/_files/goodData_suppliesAndServicesFormTest.xml");
        $data = array();

        foreach ($xml->suppliesAndService as $row)
        {
    ...
    {
        $xml  = simplexml_load_file(__DIR__ . "/_files/badData_suppliesAndServicesFormTest.xml");
        $data = array();
