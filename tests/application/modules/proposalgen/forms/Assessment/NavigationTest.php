...
/**
 * Class Proposalgen_Form_Assessment_NavigationTest
 */
class Proposalgen_Form_Assessment_NavigationTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Proposalgen_Form_Assessment_Navigation
     */
    protected $_form;

    public function setUp ()
    {
        $this->_form = new Proposalgen_Form_Assessment_Navigation();
        parent::setUp();
    }
