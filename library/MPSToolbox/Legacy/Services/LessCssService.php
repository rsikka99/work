...
class LessCssService
{
    ...
    {
        self::initialize($forceRecompile);
        My_Less::autoCompileLess(PUBLIC_PATH . '/themes/' . self::getTheme() . '/less/site/styles.less', PUBLIC_PATH . '/themes/' . self::getTheme() . '/css/site/styles.css', self::getTheme(), $forceRecompile);
    }
