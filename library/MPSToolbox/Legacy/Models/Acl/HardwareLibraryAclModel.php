...
class HardwareLibraryAclModel
{
    ...
    const RESOURCE_HARDWARE_LIBRARY_SKU_WILDCARD        = 'hardware-library__sku__%';
    const RESOURCE_HARDWARE_LIBRARY_SUPPLY_MAPPING_WILDCARD        = 'hardware-library__supply-mapping__%';
    ...
    private static function setupAclResources (AppAclModel $acl)
    {
        ...
        $acl->addResource(self::RESOURCE_HARDWARE_LIBRARY_SKU_WILDCARD);
        $acl->addResource(self::RESOURCE_HARDWARE_LIBRARY_SUPPLY_MAPPING_WILDCARD);
