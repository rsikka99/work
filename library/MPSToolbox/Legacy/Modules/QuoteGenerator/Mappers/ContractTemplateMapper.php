...
/**
 * Class ContractTemplateMapper
 *
 * @package MPSToolbox\Legacy\Modules\QuoteGenerator\Mappers
 */
class ContractTemplateMapper extends My_Model_Mapper_Abstract
{
    /*
     ...
     *
     */
    protected $_defaultDbTable = 'MPSToolbox\Legacy\Modules\QuoteGenerator\DbTables\ContractTemplateDbTable';
    ...
    /**
     * Saves an instance of MPSToolbox\Legacy\Modules\QuoteGenerator\Models\ContractTemplateModel to the database.
     * If the id is null then it will insert a new row
     *
     * @param $object ContractTemplateModel
    ...
    /**
     * Saves (updates) an instance of MPSToolbox\Legacy\Modules\QuoteGenerator\Models\ContractTemplateModel to the database.
     *
     * @param $object     ContractTemplateModel
     ...
     *
     * @param $object mixed
     *                This can either be an instance of MPSToolbox\Legacy\Modules\QuoteGenerator\Models\ContractTemplateModel or the
    ...
    {
        if ($object instanceof ContractTemplateModel)
        {
            $whereClause = [
    ...
    public function find ($id)
    {
        ...
        if ($result instanceof ContractTemplateModel)
        {
            return $result;
        }
        ...
        $row    = $result->current();
        $object = new ContractTemplateModel($row->toArray());
    ...
    /**
     *
     * @param ContractTemplateModel $object
     *
     * @return int
     */
