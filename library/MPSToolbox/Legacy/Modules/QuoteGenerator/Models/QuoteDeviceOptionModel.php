...
/**
 * Class QuoteDeviceOptionModel
 *
 * @package MPSToolbox\Legacy\Modules\QuoteGenerator\Models
 */
class QuoteDeviceOptionModel extends My_Model_Abstract
{
     ...
     *
     * @return DeviceOptionModel The option, or false if no link exists
     */
    public function getDeviceOption ()
    {
        if (!isset($this->_deviceOption))
        {
            ...
            $quoteDeviceConfigurationOption = QuoteDeviceConfigurationOptionMapper::getInstance()->findByQuoteDeviceOptionId($this->id);
     ...
     *
     * @param DeviceOptionModel $_option
     *
     * @return $this
     */
