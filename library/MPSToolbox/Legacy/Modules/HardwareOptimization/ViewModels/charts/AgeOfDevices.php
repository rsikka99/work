...
$value1=$model->deviceAges[0];
$value2=$model->deviceAges[2];
$value3=$model->deviceAges[4];
$value4=$model->deviceAges[8];
...
$myPicture->drawText(90, 30, 'Age Of Devices', ["FontSize" => 9, "R" => 0, "G" => 0, "B" => 0, "Align" => TEXT_ALIGN_BOTTOMMIDDLE]);
