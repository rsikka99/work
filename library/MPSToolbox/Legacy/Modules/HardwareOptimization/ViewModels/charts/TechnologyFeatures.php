...
$value1=round(100 * $model->deviceCategories["current"]["copy"] / $purchaseDeviceCount);
$value2=round(100 * $model->deviceCategories["current"]["duplex"] / $purchaseDeviceCount);
$value3=round(100 * $model->deviceCategories["current"]["color"] / $purchaseDeviceCount);
...
$myPicture->drawText(90, 30, 'Technology Features', ["FontSize" => 9, "R" => 0, "G" => 0, "B" => 0, "Align" => TEXT_ALIGN_BOTTOMMIDDLE]);
