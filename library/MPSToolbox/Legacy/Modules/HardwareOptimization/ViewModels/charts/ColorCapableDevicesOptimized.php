...
{
    $colorPercentage = round((($this->getNumberOfColorCapableDevicesWithReplacements() / $this->getDevices()->allIncludedDeviceInstances->getCount()) * 100), 2);
}
