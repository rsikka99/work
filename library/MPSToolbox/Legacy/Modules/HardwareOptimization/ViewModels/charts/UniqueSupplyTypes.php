...
$masterDevices = $model->getUniquePurchasedMasterDevices($this->getDevices()->purchasedDeviceInstances->getDeviceInstances());
...
$myPicture->drawText(90, 35, "Unique Supply Types", ["FontSize" => 9, "R" => 0, "G" => 0, "B" => 0, "Align" => TEXT_ALIGN_BOTTOMMIDDLE]);
