...
/**
 * Class MapDeviceInstanceMapper
 *
 * @package MPSToolbox\Legacy\Modules\ProposalGenerator\Mappers
 */
class MapDeviceInstanceMapper extends My_Model_Mapper_Abstract
{
    /*
     * Column Definitions
     */
     ...
     *
     */
    protected $_defaultDbTable = 'MPSToolbox\Legacy\Modules\ProposalGenerator\DbTables\MapDeviceInstanceDbTable';

    /**
     * Gets an instance of the mapper
     *
     * @return MapDeviceInstanceMapper
     */
    ...
    /**
     * Saves an instance of MPSToolbox\Legacy\Modules\ProposalGenerator\Models\MapDeviceInstanceModel to the database.
     * If the id is null then it will insert a new row
     *
     * @param $object MapDeviceInstanceModel
    ...
    /**
     * Saves (updates) an instance of MPSToolbox\Legacy\Modules\ProposalGenerator\Models\MapDeviceInstanceModel to the database.
     *
     * @param $object     MapDeviceInstanceModel
     ...
     *
     * @param $object mixed
     *                This can either be an instance of MPSToolbox\Legacy\Modules\ProposalGenerator\Models\MapDeviceInstanceModel or the
    ...
    /**
     * @param MapDeviceInstanceModel $object
     *
     * @return int
     */
...
{$groupBy}";
            ...
            {
                $mapDeviceInstances[] = new MapDeviceInstanceModel($row);
            }
