...
/**
 * Class HardwareImageForm
 * @package MPSToolbox\Forms
 */
class HardwareImageForm extends \My_Form_Form
{
    ...
    {
        $this->setMethod('post');
        $this->setAttrib('id', 'hardwareImage');
    ...
    {
        $this->setDecorators([['ViewScript', ['viewScript' => 'forms/hardware-library/hardware-image-form.phtml']]]);
    }
}