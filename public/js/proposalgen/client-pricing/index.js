    ...
    $("#clientToners").jqGrid(
        {
            ...
            colModel    : [
                ...
                {
                    width   : 90,
                    name    : 'replacementOemSku',
                    index   : 'replacementOemSku',
                    hidden  : false,
                    label   : 'New OEM SKU',
                    title   : false,
                    sortable: true
                ...
                {
                    width   : 90,
                    name    : 'replacementDealerSku',
                    index   : 'replacementDealerSku',
                    hidden  : false,
                ...
                {
                    width    : 70,
                    name     : 'replacementSavings',
                    index    : 'replacementSavings',
                    hidden   : false,
                    label    : 'Savings',
                    formatter: 'currency',
                    align    : 'right',
                ...
                {
                    width   : 160,
                    name    : 'replacementTonerId',
                    index   : 'replacementTonerId',
                    hidden  : true,
                    label   : 'Replacement Toner Id',
                    title   : false,
                    sortable: false
                },
                {
