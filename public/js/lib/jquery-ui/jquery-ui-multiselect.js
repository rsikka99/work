    ...
    (function ($, window, undefined)
    {
                        ...
                        .append($('<div></div>').addClass('ui-widget-header')
                            .append(btnDeselectAll = $('<button></button>', {type: "button"}).addClass('uix-control-right')
                                ...
                                .click(function (e)
                                {
                                    e.preventDefault();
                                    e.stopPropagation();
                                    that.optionCache.setSelectedAll(false);
                                    return false;
                                })
                        ...
                        .append($('<div></div>').addClass('ui-widget-header')
                            .append(btnSelectAll = $('<button></button>', {type: "button"}).addClass('uix-control-right')
                                ...
                                .click(function (e)
                                {
                                    e.preventDefault();
                                    e.stopPropagation();
                                    that.optionCache.setSelectedAll(true);
                                    return false;
                                })
                    ...
                    this._buttons['search'] = $('<button></button>', {type: "button"}).addClass('uix-control-right')
                        ...
                        .click(function (e)
                        {
                            ...
                            if (that._searchField.is(':visible'))
                            {
                                ...
                                that._searchField.hide('slide', {direction: 'right'}, 200, function ()
                                {
                                    b.removeClass('ui-corner-right ui-state-active').addClass('ui-corner-all');
                                });
                            ...
                            {
                                that._headers[searchHeader].fadeTo('fast', 0.1, function ()
                                {
                                    $(this).css('visibility', 'hidden');
                                });
                                $(this).removeClass('ui-corner-all').addClass('ui-corner-right ui-state-active');
                                that._searchField.show('slide', {direction: 'right'}, 200, function ()
                                {
                                    $(this).focus();
                                });
                                that._search();
        ...
        OptionCache.prototype = {
            _createGroupElement: function (grpElement, optGroup, selected)
            {
                ...
                var e = $('<div></div>')
                        ...
                        .append($('<button></button>', {type: "button"}).addClass('uix-control-right')
                            ...
                            .button({
                                icons: {primary: transferIcon(this._widget.options.availableListPosition, 'ui-icon-arrowstop-1-', selected)},
                                text : false
                            })
                            .click(function (e)
                            {
                                ...
                                if (gData.count > 0)
                                {
                                    ...
                                    that._widget._triggerUIEvent(EVENT_CHANGE, {
                                        optionElements: _transferedOptions,
                                        selected      : !selected
                                    });
                                }
                    ...
                    e.sortable({
                        ...
                        stop       : function (evt, ui)
                        {
                            ...
                            if (_received_index != undefined)
                            {
                                ...
                                that._widget._updateHeaders();
                                that._widget._triggerUIEvent(EVENT_CHANGE, {
                                    optionElements: [e.optionElement[0]],
                                    selected      : true
                                });
                            }
                            else
            ...
            _bufferedMode: function (enabled)
            {
                if (enabled)
                {
                    this._oldMoveEffect = this._moveEffect;
            ...
            reIndex: function ()
            {
                ...
                {
                    if (!v['available'].listContainer.parents('.multiselect-element-wrapper').length)
                    {  // if no parent, then it was never attached yet.
                        if (v.groupElement)
                        {
                ...
                this._groups.each(function (g, v, t)
                {
                    t._reorderSelected(g);
                }, this);
            ...
            {
                var info = {
                    'selected' : {'total': 0, 'count': 0, 'filtered': 0},
                    'available': {'total': 0, 'count': 0, 'filtered': 0}
                };
            ...
            setSelected   : function (eData, selected, silent)
            {
                ...
                if (!silent)
                {
                    ...
                    this._widget._updateHeaders();
                    this._widget._triggerUIEvent(EVENT_CHANGE, {
                        optionElements: [eData.optionElement[0]],
                        selected      : selected
                    });
                }
            },
            ...
            setSelectedAll: function (selected)
            {
                ...
                {
                    var that = this;
                    $.each(_modifiedGroups, function (g)
                    {
                        that._reorderSelected(g);
                    });
                }
        ...
        function _(p)
        {
            ...
            return t.replace(/\{([^\}]+)\}/g, function (m, n)
            {
                return data[n];
            });
        }
